...
public class GuestbookResponseServiceBean {
    ...
    public List<GuestbookResponse> findAll() {
        return emBean.getMaster().createQuery("select object(o) from GuestbookResponse as o order by o.responseTime desc", GuestbookResponse.class).getResultList();
    }
    ...
    public List<Long> findAllIds(Long dataverseId) {
        if (dataverseId == null) {
            return emBean.getMaster().createQuery("select o.id from GuestbookResponse as o order by o.responseTime desc", Long.class).getResultList();
        }
        return emBean.getMaster().createQuery("select o.id from GuestbookResponse  o, Dataset d where o.dataset.id = d.id and d.owner.id = " + dataverseId + " order by o.responseTime desc", Long.class).getResultList();
    }
    ...
    public List<GuestbookResponse> findAllByGuestbookId(Long guestbookId) {
        ...
        if (guestbookId == null) {
            ...
            return emBean.getMaster().createQuery("select o from GuestbookResponse as o where o.guestbook.id = " + guestbookId + " order by o.responseTime desc", GuestbookResponse.class).getResultList();
        }
        return null;
    }
    ...
    public void streamResponsesByDataverseIdAndGuestbookId(OutputStream out, Long dataverseId, Long guestbookId) throws IOException {
        ...
        List<Object[]> guestbookResults = emBean.getMaster().createNativeQuery(queryString).getResultList();
        ...
        for (Object[] result : guestbookResults) {
            ...
            List<Object[]> customResponses = emBean.getMaster().createNativeQuery(cqString).getResultList();
        ...
        for (Object[] result : guestbookResults) {
            ...
            if (guestbookResponseId != null) {
                ...
                if (hasCustomQuestions) {
                    ...
                    /*String cqString = "select q.questionstring, r.response  from customquestionresponse r, customquestion q where q.id = r.customquestion_id and r.guestbookResponse_id = " + result[0];
                    singleResult[5]   = emBean.getMaster().createNativeQuery(cqString).getResultList();*/
                    if (customQandAs.containsKey(guestbookResponseId)) {
    ...
    */
    ...
    public Long findCountByGuestbookId(Long guestbookId, Long dataverseId) {
        ...
        if (guestbookId == null) {
            ...
            Query query = emBean.getMaster().createNativeQuery(queryString);
    ...
    public List<Long> findAllIds30Days(Long dataverseId) {
        ...
        return emBean.getMaster().createQuery(queryString, Long.class).getResultList();
    }
    ...
    public List<GuestbookResponse> findAllByDataverse(Long dataverseId) {
        return emBean.getMaster().createQuery("select object(o) from GuestbookResponse  o, Dataset d where o.dataset.id = d.id and d.owner.id = " + dataverseId + " order by o.responseTime desc", GuestbookResponse.class).getResultList();
    }
    ...
    public List<GuestbookResponse> findAllWithin30Days(Long dataverseId) {
        ...
        queryString += " and o.responseTime<='" + endTime + "'";
        queryString += "  order by o.responseTime desc";
        TypedQuery<GuestbookResponse> query = emBean.getMaster().createQuery(queryString, GuestbookResponse.class);
    ...
    private String generateTempTableString(List<Long> datasetIds) {
        ...
        emBean.getMaster().createNativeQuery(" BEGIN; SET TRANSACTION READ WRITE; DROP TABLE IF EXISTS tempid; END;").executeUpdate();
        emBean.getMaster().createNativeQuery(" BEGIN; SET TRANSACTION READ WRITE; CREATE TEMPORARY TABLE tempid (tempid integer primary key, orderby integer); END;").executeUpdate();
        emBean.getMaster().createNativeQuery(" BEGIN; SET TRANSACTION READ WRITE; INSERT INTO tempid VALUES " + generateIDsforTempInsert(datasetIds) + "; END;").executeUpdate();
    ...
    public List<Object[]> findCustomResponsePerGuestbookResponse(Long gbrId) {
        ...
        TypedQuery<Object[]> query = emBean.getMaster().createQuery(gbrCustomQuestionQueryString, Object[].class);
    ...
    private Guestbook findDefaultGuestbook() {
        ...
        List<Guestbook> resultList = emBean.getMaster().createQuery(queryStr, Guestbook.class).getResultList();
    ...
    public void save(GuestbookResponse guestbookResponse) {
        emBean.getMaster().persist(guestbookResponse);
    }
    
    
    public Long getCountGuestbookResponsesByDataFileId(Long dataFileId) {
        // datafile id is null, will return 0
        Query query = emBean.getMaster().createNativeQuery("select count(o.id) from GuestbookResponse  o  where o.datafile_id  = " + dataFileId);
        return (Long) query.getSingleResult();
    }
    
    public Long getCountGuestbookResponsesByDatasetId(Long datasetId) {
        // dataset id is null, will return 0        
        Query query = emBean.getMaster().createNativeQuery("select count(o.id) from GuestbookResponse  o  where o.dataset_id  = " + datasetId);
        return (Long) query.getSingleResult();
    }    

    public Long getCountOfAllGuestbookResponses() {
        // dataset id is null, will return 0        
        Query query = emBean.getMaster().createNativeQuery("select count(o.id) from GuestbookResponse  o;");
        return (Long) query.getSingleResult();
    }
