...
public class BuiltinUserServiceBean {
    ...
    public BuiltinUser save(BuiltinUser aUser) {
        ...
        if ( aUser.getId() == null ) {
            ...
            if ( emBean.getMaster().createNamedQuery("BuiltinUser.findByUserName")
            ...
            emBean.getMaster().persist( aUser );
            return aUser;
        } else {
            return emBean.getMaster().merge(aUser);
        }
    }
    ...
    public BuiltinUser findByUserName(String userName) {
        try {
            return emBean.getMaster().createNamedQuery("BuiltinUser.findByUserName", BuiltinUser.class)
	...
	public List<BuiltinUser> listByUsernamePart ( String part ) {
		return emBean.getMaster().createNamedQuery("BuiltinUser.listByUserNameLike", BuiltinUser.class)
    ...
    public BuiltinUser findByEmail(String email) {
        try {
            return emBean.getMaster().createNamedQuery("BuiltinUser.findByEmail", BuiltinUser.class)
    ...
    public List<BuiltinUser> findAll() {
		return emBean.getMaster().createNamedQuery("BuiltinUser.findAll", BuiltinUser.class).getResultList();
	}
