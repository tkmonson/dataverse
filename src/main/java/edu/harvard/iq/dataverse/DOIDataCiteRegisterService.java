...
public class DOIDataCiteRegisterService {
    ...
    public DOIDataCiteRegisterCache findByDOI(String doi) {
        TypedQuery<DOIDataCiteRegisterCache> query = emBean.getMaster().createNamedQuery("DOIDataCiteRegisterCache.findByDoi",
