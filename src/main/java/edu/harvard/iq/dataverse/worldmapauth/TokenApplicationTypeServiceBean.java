...
public class TokenApplicationTypeServiceBean {
    ...
    */
    ...
    public TokenApplicationType findByName(String name){
        ...
        try{
            return emBean.getMaster().createQuery("select m from TokenApplicationType m WHERE m.name=:name", TokenApplicationType.class)
    ...
    public List<TokenApplicationType> getAllTokenApplicationTypes(){
        ...
        TypedQuery<TokenApplicationType> query = emBean.getMaster().createQuery(qr, TokenApplicationType.class);
