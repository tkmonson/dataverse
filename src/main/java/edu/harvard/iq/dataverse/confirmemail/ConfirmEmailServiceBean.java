...
public class ConfirmEmailServiceBean {
    ...
    private ConfirmEmailInitResponse sendConfirm(AuthenticatedUser aUser, boolean sendEmail) throws ConfirmEmailException {
        ...
        aUser = emBean.getMaster().merge(aUser);
        ...
        try {
             ...
             * ConfirmEmailIT.
             */
            emBean.getMaster().persist(confirmEmailData);
    ...
    private ConfirmEmailData findSingleConfirmEmailDataByToken(String token) {
        ...
        TypedQuery<ConfirmEmailData> typedQuery = emBean.getMaster().createNamedQuery("ConfirmEmailData.findByToken", ConfirmEmailData.class);
    ...
    public ConfirmEmailData findSingleConfirmEmailDataByUser(AuthenticatedUser user) {
        ConfirmEmailData confirmEmailData = null;
        TypedQuery<ConfirmEmailData> typedQuery = emBean.getMaster().createNamedQuery("ConfirmEmailData.findByUser", ConfirmEmailData.class);
    ...
    public List<ConfirmEmailData> findAllConfirmEmailData() {
        TypedQuery<ConfirmEmailData> typedQuery = emBean.getMaster().createNamedQuery("ConfirmEmailData.findAll", ConfirmEmailData.class);
