...
public class UserServiceBean {
    ...
    public AuthenticatedUser save(AuthenticatedUser user) {
        if (user.getId() == null) {
            ...
            user = emBean.getMaster().merge(user);
        }
    ...
    private HashMap<String, List<String>> retrieveRolesForUsers(List<Object[]> userObjectList){
        ...
        Query nativeQuery = emBean.getMaster().createNativeQuery(qstr);
        ...
        //SystemBean.getMaster().out.println("qstr: " + qstr);

        nativeQuery = emBean.getMaster().createNativeQuery(qstr);
            ...
            if ((groupIdentifier != null)&&(groupRole != null)){  // should never be null
                ...
                if (groupUserList != null) {
                    ...
                    for (String groupUserIdentifier : groupUserList) {
                        ...
                        //SystemBean.getMaster().out.println("Group user: "+groupUserIdentifier);
                        ...
                        if (!userRoleList.contains(groupRole)){
                            //SystemBean.getMaster().out.println("User Role: "+groupRole);
    ...
    public Long getSuperUserCount() {
        ...
        Query query = emBean.getMaster().createQuery(qstr);
