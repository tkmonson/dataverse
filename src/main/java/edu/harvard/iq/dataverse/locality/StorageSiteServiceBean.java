...
public class StorageSiteServiceBean {
    ...
    public StorageSite find(long id) {
        TypedQuery<StorageSite> typedQuery = emBean.getMaster().createQuery("SELECT OBJECT(o) FROM StorageSite AS o WHERE o.id = :id", StorageSite.class);
    ...
    public List<StorageSite> findAll() {
        ...
        TypedQuery<StorageSite> typedQuery = emBean.getMaster().createQuery("SELECT OBJECT(o) FROM StorageSite AS o ORDER BY o.id", StorageSite.class);
    ...
    public StorageSite save(StorageSite storageSite) {
        return emBean.getMaster().merge(storageSite);
    }
