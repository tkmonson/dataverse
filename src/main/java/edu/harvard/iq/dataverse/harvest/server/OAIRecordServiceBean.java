...
public class OAIRecordServiceBean implements java.io.Serializable {
        ...
        if (datasetIds != null) {
            for (Long datasetId : datasetIds) {
                ...
                if (dataset == null) {
                    ...
                    emBean.getMaster().refresh(dataset);
    ...
    public void updateOaiRecordForDataset(Dataset dataset, String setName, Map<String, OAIRecord> recordMap, Logger setUpdateLogger) {
        ...
        if (isReleased && dataset.getLastExportTime() != null) {
            ...
            if (record == null) {
                ...
                emBean.getMaster().persist(record);
            } else {
                if (record.isRemoved()) {
    ...
    public OAIRecord findOAIRecordBySetNameandGlobalId(String setName, String globalId) {
        ...
        TypedQuery query = emBean.getMaster().createQuery(queryString, OAIRecord.class).setParameter("globalId",globalId);
    ...
    public List<OAIRecord> findOaiRecordsByGlobalId(String globalId) {
        ...
        try {
            oaiRecords = emBean.getMaster().createQuery(query, OAIRecord.class).setParameter("globalId",globalId).getResultList();
        } catch (Exception ex) {
    ...
    public List<OAIRecord> findOaiRecordsBySetName(String setName, Date from, Date until, boolean excludeSet) {
        ...
        TypedQuery<OAIRecord> query = emBean.getMaster().createQuery(queryString, OAIRecord.class);
        if (setName != null) { query.setParameter("setName",setName); }
