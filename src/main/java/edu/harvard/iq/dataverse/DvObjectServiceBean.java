...
public class DvObjectServiceBean implements java.io.Serializable {
    ...
    public boolean hasData(DvObjectContainer dvoc) {
        return emBean.getMaster().createNamedQuery("DvObject.ownedObjectsById", Long.class)
    ...
    public DvObject findDvObject(Long id) {
        try {
            return emBean.getMaster().createNamedQuery("DvObject.findById", DvObject.class)
                    .setParameter("id", id)
                    .getSingleResult();
    ...
    public List<DvObject> findAll() {
        return emBean.getMaster().createNamedQuery("DvObject.findAll", DvObject.class).getResultList();
    }
    ...
    public DvObject findByGlobalId(String globalIdString, String typeString) {
        ...
        try {
            ...
            try {
                Query query;
                query = emBean.getMaster().createNamedQuery("DvObject.findByGlobalId");
    ...
    public DvObject updateContentIndexTime(DvObject dvObject) {
        ...
        DvObject savedDvObject = emBean.getMaster().merge(dvObjectToModify);
    ...
    public int clearAllIndexTimes() {
        Query clearIndexTimes = emBean.getMaster().createQuery("UPDATE DvObject o SET o.indexTime = NULL, o.permissionIndexTime = NULL");
        int numRowsUpdated = clearIndexTimes.executeUpdate();
        return numRowsUpdated;
    }

    public int clearIndexTimes(long dvObjectId) {
        Query clearIndexTimes = emBean.getMaster().createQuery("UPDATE DvObject o SET o.indexTime = NULL, o.permissionIndexTime = NULL WHERE o.id =:dvObjectId");
    ...
    public List<Object[]> getDvObjectInfoForMyData(List<Long> dvObjectIdList){
        ...
        return emBean.getMaster().createNativeQuery(qstr).getResultList();
