...
public class PermissionServiceBean {
    ...
    public List<RoleAssignment> assignmentsOn(DvObject d) {
        return emBean.getMaster().createNamedQuery("RoleAssignment.listByDefinitionPointId", RoleAssignment.class)
    ...
    */
    ...
    public List<Long> getDvObjectIdsUserHasRoleOn(User user, List<DataverseRole> roles, List<String> types, boolean indirect) {
        ...
        Query nativeQuery = emBean.getMaster().createNativeQuery("SELECT id FROM dvobject WHERE "
        ...
        if (indirect) {
            indirectParentIds += ") ";
            Query nativeQueryIndirect = emBean.getMaster().createNativeQuery("SELECT id FROM dvobject WHERE "
            ...
            Query nativeQueryFileIndirect = emBean.getMaster().createNativeQuery("SELECT id FROM dvobject WHERE "
